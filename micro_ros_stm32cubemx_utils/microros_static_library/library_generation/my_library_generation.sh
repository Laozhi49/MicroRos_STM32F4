...
#bash ~/STM32Project/MicroRos_STM32F4/micro_ros_stm32cubemx_utils/microros_static_library/library_generation/my_library_generation.sh

export ROS_DISTRO=jazzy
export PROJECT=~/STM32Project/MicroRos_STM32F4
export BASE_PATH=~/STM32Project/MicroRos_STM32F4/micro_ros_stm32cubemx_utils/microros_static_library
